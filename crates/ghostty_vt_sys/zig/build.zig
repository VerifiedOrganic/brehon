...
pub fn build(b: *std.Build) void {
    ...
    const props_output = wf.addCopyFile(captureStdOutCompat(props_run), "props.zig");
    const symbols_output = wf.addCopyFile(captureStdOutCompat(symbols_run), "symbols.zig");
...
fn captureStdOutCompat(run: *std.Build.Step.Run) std.Build.LazyPath {
