...
pub fn build(b: *std.Build) void {
    ...
    putModuleCompat(b, "uucode", mod.lib);
...
fn putModuleCompat(b: *std.Build, name: []const u8, module: *std.Build.Module) void {
    if (builtin.zig_version.major == 0 and builtin.zig_version.minor >= 16) {
        _ = b.modules.put(b.graph.arena, b.dupe(name), module) catch @panic("OOM");
        return;
    }

    _ = b.modules.put(b.dupe(name), module) catch @panic("OOM");
}
