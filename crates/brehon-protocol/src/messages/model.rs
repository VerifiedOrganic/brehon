...
/// Metadata about an available session, returned in `SessionList`.
...
pub struct PaneInfo {
    ...
    pub exited: bool,
    /// Current harness transport, when known.
    #[serde(default)]
    pub transport: Option<String>,
    /// Preferred structured control plane, when known.
    #[serde(default)]
    pub control_plane: Option<String>,
    /// ACP session state, when known.
    #[serde(default)]
    pub session_state: Option<String>,
    /// ACP turn state, when known.
    #[serde(default)]
    pub turn_state: Option<String>,
    /// Human-readable ACP detail for UI display.
    #[serde(default)]
