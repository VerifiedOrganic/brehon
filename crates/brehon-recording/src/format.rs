//! Binary recording file format for Brehon Factory terminal recordings.
//!
...
/// Magic bytes identifying an Brehon recording file: "AGREC\x00\x00\x01"
pub const MAGIC: [u8; 8] = [b'A', b'G', b'R', b'E', b'C', 0x00, 0x00, 0x01];

/// Legacy magic bytes for backward-compatible reading: "CASREC\x00\x01"
pub const LEGACY_MAGIC: [u8; 8] = [b'C', b'A', b'S', b'R', b'E', b'C', 0x00, 0x01];
...
pub enum FormatError {
    #[error("Invalid magic bytes - not a Brehon recording file")]
    InvalidMagic,
    ...
    #[error("Decompressed recording exceeds limit of {limit} bytes")]
