//! Terminal recording format and utilities for Brehon Factory.
//!
//! This crate provides the binary file format for recording and playing back
//! terminal sessions from Brehon Factory agents.
//!
//! # Overview
//!
...
//!
//! ```ignore
//! use brehon_recording::{RecordingWriter, WriterConfig};
//!
...
//!
//! ```ignore
//! use brehon_recording::RecordingReader;
//!
//! // Open recording
...
pub use format::{
    DEFAULT_KEYFRAME_INTERVAL_MS, FORMAT_VERSION, FormatError, KeyframeEntry, KeyframeIndex,
    LEGACY_MAGIC, MAGIC, RecordingEvent, RecordingHeader,
};
...
pub use export::{
    ...
    ExportResult, ExportStats, LEGACY_ARCHIVE_MAGIC, ManifestExtra, RecordedEvent, export_session,
