//! PTY management for Brehon factory mode
//!
...
//!
//! ```rust,no_run
//! use brehon_pty::{Pty, PtyConfig, PtyEvent};
//! use std::path::PathBuf;
//!
//! #[tokio::main]
//! async fn main() -> brehon_pty::Result<()> {
...
//!                 // Reply with the parser's real cursor position; see
//!                 // [`format_cursor_position_report`].
//!             }
